    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Text(
            title,
            style: GoogleFonts.cairo(fontSize: 13, fontWeight: FontWeight.w700, color: KalimaTheme.textMuted),
          ),
        ),
        Container(
...
class _SettingsTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Row(
        children: [
          Icon(icon, color: KalimaTheme.accent, size: 22),
          const SizedBox(width: 12),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(title, style: GoogleFonts.cairo(fontSize: 15, fontWeight: FontWeight.w700, color: Colors.white)),
                Text(subtitle, style: GoogleFonts.cairo(fontSize: 12, color: KalimaTheme.textMuted)),
              ],
            ),
          ),
          trailing,
