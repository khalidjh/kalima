...
const PUZZLES: NahlaPuzzle[] = [
  ...
  },
  {
    ...
    requiredLetter: "ن",
    validWords: ["نور","نورة","نوارة","نهر","نمرة","نومة","نومة","ناري","نام","ناموس","نمو","منارة","منور","منح","منحة","نحوية","نورة","رومن","روماني","مونة","حون","حانة","جوار","روح","روحانية","نيران","نمارق","مناور","نوام","نيمة"],
  ...
  },
  {
    ...
    requiredLetter: "ص",
    validWords: ["صفر","صفرة","صفا","صفي","صنف","صنافة","صار","صارم","صارمة","صرام","صرامة","صفن","صنفور","نصفر","صفرة","نافذة","صنارة","فرسان","فرسنة","مرصوف","مصفاة","رصف","رصافة","صمان"],
  ...
  },
  {
    ...
    requiredLetter: "و",
    validWords: ["وزن","وزنة","وزير","وزارة","رويز","موز","موزة","ميرة","موري","موريس","ورم","ورمة","وريد","ورود","وردة","نورة","نورية","زيتونة","رومي","رومية","نيمورة","يمورة","يوزو","زورية","نورية"],
